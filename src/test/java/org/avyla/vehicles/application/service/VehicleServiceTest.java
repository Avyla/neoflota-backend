...
class VehicleServiceTest {
    ...
    class CreateTests {
        ...
        void shouldCreateVehicleSuccessfully() {
            ...
            assertThat(response.getModelName()).isEqualTo("Hilux");
            assertThat(response.getModelYear()).isEqualTo(2023);
            assertThat(response.isActive()).isTrue();
            assertThat(response.getCreatedByUserId()).isEqualTo(currentUserId);
        ...
        void shouldNormalizePlateToUppercase() {
            ...
            VehicleCreateRequest request = new VehicleCreateRequest(
                "abc123", // minúsculas
                1L, 1L, "Model", 2023, 1L, 1L, 1L, 1L, 1L,
        ...
        void shouldThrowBadRequestExceptionWhenPlateExists() {
            ...
            // When & Then
            assertThatThrownBy(() -> vehicleService.create(request, 1L))
                .isInstanceOf(BadRequestException.class)
                .hasMessageContaining("Ya existe un vehículo con la placa: ABC123");
        ...
        void shouldCreateVehicleWithoutCondition() {
            ...
            VehicleCreateRequest request = new VehicleCreateRequest(
                "ABC123",
                1L, 1L, "Model", 2023, 1L, 1L, 1L, 1L,
                null, // conditionId es null
                null, null, null, null, null
            );
            ...
            // Then
            assertThat(response).isNotNull();
            assertThat(response.getConditionId()).isNull();
    ...
    class GetByIdTests {
        ...
        void shouldGetVehicleById() {
            ...
            assertThat(response.getPlate()).isEqualTo(mockVehicle.getPlate());
            assertThat(response.getMakeName()).isEqualTo("Toyota");
            assertThat(response.getTypeName()).isEqualTo("Camioneta");
        ...
        void shouldCalculateDaysToSoatExpiration() {
            ...
            Vehicle vehicle = TestDataBuilder.vehicleBuilder()
                .soatExpirationDate(LocalDate.now().plusDays(30))
                .build();
            ...
            // Then
            assertThat(response.getDaysToSoatExpiration()).isNotNull();
            assertThat(response.getDaysToSoatExpiration()).isGreaterThanOrEqualTo(29L);
            assertThat(response.getDaysToSoatExpiration()).isLessThanOrEqualTo(30L);
        }
    }
    ...
    class UpdateTests {
        ...
        void shouldUpdateOnlyProvidedFields() {
            ...
            VehicleUpdateRequest request = new VehicleUpdateRequest(
                null, // makeId - no actualizar
                null, // typeId - no actualizar
                "Hilux 4x4", // nuevo modelName
                2024, // nuevo año
                null, null, null, null,
            ...
            // Then
            assertThat(response.getModelName()).isEqualTo("Hilux 4x4");
            assertThat(response.getModelYear()).isEqualTo(2024);
        ...
        void shouldUpdateAuditFields() {
            ...
            VehicleUpdateRequest request = new VehicleUpdateRequest(
                null, null, "NewModel", null, null, null, null, null, null,
                null, null, null, null, null, null
            );
        ...
        void shouldThrowNotFoundExceptionWhenVehicleNotFound() {
            ...
            Long vehicleId = 999L;
            VehicleUpdateRequest request = new VehicleUpdateRequest(
                null, null, "Model", null, null, null, null, null, null,
                null, null, null, null, null, null
            );
        ...
        void shouldUpdateCatalogsWhenProvided() {
            // Given
            VehicleMake newMake = TestDataBuilder.createVehicleMake(2L, "Ford", "USA");
            VehicleUpdateRequest request = new VehicleUpdateRequest(
                2L, // nueva marca
    ...
    class DeactivateActivateTests {
        ...
        void shouldThrowNotFoundExceptionWhenDeactivatingNonExistent() {
            ...
            // When & Then
            assertThatThrownBy(() -> vehicleService.deactivate(999L, 1L))
                .isInstanceOf(NotFoundException.class)
                .hasMessageContaining("Vehículo no encontrado: 999");
        }
    }
    ...
    class FindExpiringTests {
        ...
        void shouldFindExpiringVehicles() {
            // Given
            int days = 30;
            Vehicle expiringSoon = TestDataBuilder.vehicleBuilder()
                .soatExpirationDate(LocalDate.now().plusDays(15))
                .build();

            LocalDate limit = LocalDate.now().plusDays(days);
            when(vehicleRepo.findExpiringByDate(limit))
            ...
            assertThat(result.get(0).getDaysToSoat()).isNotNull();
            assertThat(result.get(0).getDaysToSoat()).isLessThanOrEqualTo(30L);
